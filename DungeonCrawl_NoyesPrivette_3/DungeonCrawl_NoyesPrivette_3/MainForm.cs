                ...
                if(room.currentRoom == true)
                {
                    ...
                    foreach(Enemy enemy in room.enemiesList)
                    {
                        ...
                        if(item == enemy.name)
                        {
                            ...
                            infoListBox.Items.Add(enemy.health);
                            infoListBox.Items.Add(enemy.attack);
                            infoListBox.Items.Add(enemy.defense);
                            infoListBox.Items.Add(enemy.dexterity);
                            infoListBox.Items.Add(enemy.intelligence);
                            infoListBox.Items.Add(enemy.wisdom);
                        }
                    }
